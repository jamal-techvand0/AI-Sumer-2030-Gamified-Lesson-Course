  ...
  return (
    <div className="onboarding">
      ...
      <div className="onboarding-bg">
        ...
        <div className="onboarding-floating-emoji e1">
          <Music2 size={20} />
        </div>
        <div className="onboarding-floating-emoji e2">
          <Palette size={20} />
        </div>
        <div className="onboarding-floating-emoji e3">
          <Sparkles size={20} />
        </div>
        <div className="onboarding-floating-emoji e4">
          <Rocket size={20} />
        </div>
        <div className="onboarding-floating-emoji e5">
          <Trophy size={20} />
        </div>
      </div>
      ...
      {/* Steps */}
      <div
        className={`onboarding-step-container ${transitioning ? "exit" : "enter"}`}
      >
        {step === 0 && (
        ...
        {step === 2 && (
          <div className="onboarding-step animate-fadeInUp">
            <Mascot
              message={`A ${animal}! Amazing choice, ${name}! Get ready for 20 days of creating incredible things — songs, stories, art, videos, and so much more — all starring your ${animal}! Let's go!`}
              size="xl"
              mood="celebrating"
            />
            <div className="onboarding-input-area">
              <div className="onboarding-journey-preview">
                <h2 className="onboarding-question">
                  Your 20-Day AI Adventure Awaits!
                </h2>
              ...
              >
                <Rocket size={18} /> Start My Adventure!
              </button>
            </div>
          </div>
        )}
